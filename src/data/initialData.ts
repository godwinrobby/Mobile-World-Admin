...
export const INITIAL_EXCHANGES: TradeInExchange[] = [
  ...
  {
    id: 'ex-8803',
    exchangeCode: 'EXCH-2026-003',
    timestamp: '2026-08-06 16:30',
    customerName: 'Neha Sharma',
    customerPhone: '+91 98765 12345',
    customerGovtId: 'Aadhar **** 8812',
    deviceBrand: 'OnePlus',
    deviceModel: 'OnePlus 10 Pro 5G',
    storageColor: '256GB Emerald Forest',
    imeiNumber: '864920192837119',
    condition: {
      screenOk: true,
      screenCondition: 'Minor Scratch',
      bodyCondition: 'Light Scratches',
    ...
    agreedValue: 21500,
    grade: 'Grade B (Minor Wear)',
    actionTaken: 'Store Credit Voucher',
    voucherCode: 'VOUCHER-EX21K',
    isVoucherUsed: false,
    status: 'Completed',
    inspectorStaff: 'Priya Patel',
    notes: 'Issued store credit voucher for future accessories or phone purchase.'
  },
  {
    id: 'ex-8804',
    exchangeCode: 'EXCH-2026-004',
    timestamp: '2026-08-05 15:10',
    customerName: 'Rahul Verma',
    customerPhone: '+91 98100 44556',
    customerGovtId: 'Aadhar **** 3321',
    deviceBrand: 'Apple',
    deviceModel: 'iPhone 13',
    storageColor: '128GB Midnight',
    imeiNumber: '352901827364512',
    condition: {
      screenOk: true,
      screenCondition: 'No Scratch',
      bodyCondition: 'Light Scratches',
    ...
    calculatedValue: 26000,
    agreedValue: 25500,
    grade: 'Grade B (Minor Wear)',
    actionTaken: 'Direct Sale Adjustment',
    voucherCode: 'VOUCHER-EX25K',
    isVoucherUsed: true,
    status: 'Completed',
    inspectorStaff: 'Anish Verma',
    notes: 'Traded in against iPhone 15 purchase.'
  },
  {
    id: 'ex-8805',
    exchangeCode: 'EXCH-2026-005',
    timestamp: '2026-08-04 12:20',
    customerName: 'Karan Patel',
    customerPhone: '+91 97233 11223',
    customerGovtId: 'PAN XYZPK9928L',
    deviceBrand: 'Xiaomi',
    deviceModel: 'Xiaomi 13 Pro',
    storageColor: '256GB Ceramic Black',
    ...
    status: 'In Refurbish',
    inspectorStaff: 'Rajesh Sharma',
    notes: 'Glass repair needed before listing in refurbish catalog.'
  },
  {
    id: 'ex-8806',
    exchangeCode: 'EXCH-2026-006',
    timestamp: '2026-08-03 17:55',
    customerName: 'Sanjay Gupta',
    customerPhone: '+91 98450 77889',
    customerGovtId: 'Aadhar **** 1092',
    deviceBrand: 'Samsung',
    deviceModel: 'Galaxy S23 Ultra',
    storageColor: '256GB Green',
    imeiNumber: '358201928374621',
    condition: {
      screenOk: true,
      screenCondition: 'No Scratch',
      bodyCondition: 'Flawless',
    ...
    calculatedValue: 58000,
    agreedValue: 58000,
    grade: 'Grade A (Flawless)',
    actionTaken: 'Store Credit Voucher',
    voucherCode: 'VOUCHER-EX58K',
    isVoucherUsed: false,
    status: 'Completed',
    inspectorStaff: 'Priya Patel',
    notes: 'Planned exchange for S24 Ultra.'
  },
  {
    id: 'ex-8807',
    exchangeCode: 'EXCH-2026-007',
    timestamp: '2026-08-02 10:15',
    customerName: 'Ananya Roy',
    customerPhone: '+91 98311 99001',
    customerGovtId: 'Aadhar **** 6610',
    deviceBrand: 'Google Pixel',
    deviceModel: 'Pixel 7 Pro',
    storageColor: '128GB Hazel',
    imeiNumber: '351920384756192',
    condition: {
      screenOk: true,
      screenCondition: 'Minor Scratch',
      bodyCondition: 'Light Scratches',
    ...
    calculatedValue: 24000,
    agreedValue: 23500,
    grade: 'Grade B (Minor Wear)',
    actionTaken: 'Added to Refurbish Stock',
    status: 'In Refurbish',
    inspectorStaff: 'Anish Verma',
    notes: 'Clean device, sent to refurbish stock.'
  },
  {
    id: 'ex-8808',
    exchangeCode: 'EXCH-2026-008',
    timestamp: '2026-08-01 14:00',
    customerName: 'Deepak Joshi',
    customerPhone: '+91 97122 33445',
    customerGovtId: 'Aadhar **** 7723',
    deviceBrand: 'Vivo',
    deviceModel: 'Vivo X90 Pro',
    storageColor: '256GB Legendary Black',
    imeiNumber: '869012938475612',
    condition: {
      screenOk: true,
      screenCondition: 'No Scratch',
      bodyCondition: 'Light Scratches',
